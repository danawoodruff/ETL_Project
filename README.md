...
<br>
   The .sql version is uploaded to PGAdmin4 for table creation. Tables were checked for correct importation and adjustments made as needed to ERD and data files.<br>
   <br>
