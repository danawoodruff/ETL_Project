...
* To replicate the database the user only needs to run the Jupyter Notebook.: https://github.com/danawoodruff/ETL_Project/blob/main/Master_file_v11.ipynb<br>
