...
<br>
    To reproduce the pipeline, run the Jupyter Notebook that is included in the repository: <br>
    
  1. <a href="https://github.com/plqualls/ETL_Project/blob/main/Master_file_v11.ipynb">Master_file_v11</a>
