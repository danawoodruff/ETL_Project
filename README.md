...
<br>
    To reproduce the pipeline, run the Jupyter Notebook that is included in the repository:[Master_file_v11](https://github.com/plqualls/ETL_Project/blob/main/Master_file_v11.ipynb)
    <br>
